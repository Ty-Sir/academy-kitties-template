...
interface IKittyMarketPlace {
    ...
    /**
    * Set the current KittyContract address and initialize the instance of catcontract.
    * Requirement: Only the contract owner can call.
     */
    function setKittyContract(address _CatContractAddress) external;
    ...
    * Emits the MarketTransaction event with txType 'Offer Created'
